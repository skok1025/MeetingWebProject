...
<body>
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
		...
		<div id="content" class="mdl-grid portfolio-max-width">
			<h1>My Page</h1>
			<h2>회원탈퇴</h2>
			<form onsubmit="return confirm('탈퇴하시겠습니까?');" id="pwcheck" method="post" action="/Meeting/mypage/withdrawok.do">
				<div class="row" style="margin-top: 200px;">
					
					<p style="text-align: center;">탈퇴사유(사이트 발전에 도움이 됩니다!!):</p>
					<div class="input-field" style="width: 300px; margin: 0px auto;">
						
						<input id="reason" name="reason" type="text" > <label
							for="reason"> <i class="material-icons">help</i><i style="margin-left: 10px;">Reason</i></label>
					</div>
					
					<p style="text-align: center; margin-top: 30px;">비밀번호를 입력해주세요:</p>
					<div class="input-field" style="width: 300px; margin: 0px auto;">
