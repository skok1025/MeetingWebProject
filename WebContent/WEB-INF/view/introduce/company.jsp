...
<title>GM Company</title>

<jsp:include page="/inc/asset.jsp"></jsp:include>
<script src="<%= request.getContextPath() %>/asset/js/highcharts.js"> 
<style>
#content {
	display: block;
	min-height: 1000px;
...
<body>
	<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
		<jsp:include page="/inc/header.jsp">
			<jsp:param value="company Introduce" name="pageName"/>
		</jsp:include>
		...
		<div id="content" class="mdl-grid portfolio-max-width">
			...
			<%-- <div class="parallax-container">
				<div class="parallax">
					<img src="<%=request.getContextPath() %>/images/image (3).jpg">
				</div>
			</div> --%>
			
			<div class="section white">
				<div class="row container">
					<h2 class="header"><span style="font-size: .85em;">(주) </span> 광민<span style="color: #EE3B3E;">愛</span>듀오는?</h2>
					<p class="grey-text text-darken-3 lighten-3">'광민愛듀오'는 2010년 설립 이래, 여러 회원들의 매칭에 힘써왔습니다.<br>언제나 가족을 모시는 마음으로 회원 여러분들을 모시도록 하겠습니다.<br>
					현재 광민愛듀오 남녀 분포와 데이트 분포 자료를 통하여 여러분의 소중한 인연을 찾아보세요!<br>언제나 초심을 잃지 않고 노력하는 광민愛듀오가 되겠습니다. <br><br> -광민愛듀오 일동 올림</p>
				</div>
			</div>
