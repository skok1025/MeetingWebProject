           ...
           <main class="mdl-layout__content">
			...
			<div id="desc">
               ...
               <div id="content" class="mdl-grid portfolio-max-width">
                   ...
                   <form action="/Meeting/main/adduserok.do" method="get">
                      ...
                      <div id="question">
                           ...
                           <input id="btn" type="submit" value="가입 완료" class="btn-large" />
                      </div>
                      ...
                      <input type="hidden" name="extrovert" value="${extrovert }"/>
