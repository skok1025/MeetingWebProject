	...
	font-family: "InkLipquid";
       ...
       <script>
         ...
         $(document).ready(function(){
                ...
                $(".myanswer").keydown(function(event){
                	if(event.keyCode==13){
                		//alert("enter");
                		//alert($(this).attr("id"));
                		//alert($(this).val());
           ...
           <main class="mdl-layout__content">
			...
			<div id="desc">
               ...
               <div id="content" class="mdl-grid portfolio-max-width">
                   ...
                   <form action="/Meeting/main/sensetest.do" method="get">
                           ...
                           <c:forEach items="${list}" var="list">
                              <div id="pq${list.seq}" class="pq">
                                ...
                                <%--  <span class="answer_txt"><a href="javascript:answer(${list.seq},'y');">YES</a></span>
                                 ...
                                 <span class="answer_txt"><div
						class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input class="mdl-textfield__input myanswer" type="text" id="${list.seq}"
