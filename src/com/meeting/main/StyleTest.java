...
/**
 * 회원가입시, 진행하는 스타일 테스트 관련 Servlet 클래스
 * @author 김석현
 *
 */
@WebServlet("/main/styletest.do")
public class StyleTest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println("plan:"+scorecnt);
		
		// StyleTest 가져오기
		JoinDAO dao = new JoinDAO();
		 ArrayList<ExamDTO> list = dao.getTestList("Style");
		...
		req.setAttribute("plan", scorecnt);
		req.setAttribute("gender", gender);
		
		
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/view/main/styletest.jsp");
